...
public class OperationController {
    ...
    public record ProgressResponse(Integer percent, String phase, String detail) {
        ...
        static ProgressResponse from(OperationProgress progress) {
            return progress == null
                    ? null
                    : new ProgressResponse(progress.percent(), progress.phase(), progress.detail());
        }
    }
    ...
    public record OperationResponse(
        ...
        static OperationResponse from(Operation operation) {
            ...
            return new OperationResponse(
                    operation.id().asString(),
                    repositoryId == null ? null : repositoryId.asString(),
                    operation.type(),
                    operation.state(),
    ...
    public List<OperationResponse> list(
        ...
        RepositoryId repository = repositoryId == null || repositoryId.isBlank()
                ? null
    ...
    public OperationResponse show(@PathVariable String id) {
        return queue.find(OperationId.of(id))
     ...
     *
     * @throws NoSuchElementException if there is no such operation, or it already finished
     */
    ...
    public void cancel(@PathVariable String id) {
        ...
        if (!queue.cancel(operationId)) {
            throw new NoSuchElementException(
                    "No cancellable operation with id " + id + " (unknown or already finished)");
        }
    }
}
