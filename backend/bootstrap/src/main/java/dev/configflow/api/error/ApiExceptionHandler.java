...
public class ApiExceptionHandler {
    ...
    public ProblemDetail handleBadRequest(IllegalArgumentException e) {
        return problem(HttpStatus.BAD_REQUEST, "validation", "VALIDATION_ERROR",
                "Invalid request", e.getMessage());
    }

    @ExceptionHandler(UnsupportedOperationException.class)
    public ProblemDetail handleCapabilityNotSupported(UnsupportedOperationException e) {
        return problem(HttpStatus.BAD_REQUEST, "capability-not-supported", "CAPABILITY_NOT_SUPPORTED",
    ...
    public ProblemDetail handleInternal(Exception e) {
        ...
        return problem(HttpStatus.INTERNAL_SERVER_ERROR, "internal", "INTERNAL_ERROR",
                "Internal server error", "An unexpected error occurred");
    }

    private static ProblemDetail problem(
            HttpStatus status, String typeSlug, String code, String title, String detail) {
